...
@Path("/v1/" + Constantes.ENTIDAD_TIPO_MEDIA_EDIFICIO)
@Tag(description = "/v1/" + Constantes.ENTIDAD_TIPO_MEDIA_EDIFICIO, name = Constantes.ENTIDAD_TIPO_MEDIA_EDIFICIO)
public class TipoMediaEdificioResource {
	...
	@Path("/")
	@Operation(operationId = "llistarTiposMediaEdificio", summary = "Lista de tipos de media edificio", description = "Lista todos los tipos de media edificio disponibles")
	...
	public Response llistarTiposMediaEdificio(
	...
	public Response getTipoMediaEdificio(
			@Parameter(description = "Código de idioma", name = "lang", in = ParameterIn.QUERY) @DefaultValue(Constantes.IDIOMA_DEFECTO) @QueryParam("lang") final String lang,
			@Parameter(description = "Código de tipo de media edificio", required = true, name = "codigo", in = ParameterIn.PATH) @PathParam("codigo") final String codigo)
