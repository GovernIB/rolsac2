...
public class Constantes {
    ...
    public static final String ENTIDAD_PROCEDIMIENTO = "procediments";
    ...
    public static final String TESTGET_SERVICIO = "testget";
    public static final String URL_TESTGET = TESTGET_SERVICIO + "/{0}";

    public static final String TESTPOST_SERVICIO = "testpost";
    public static final String URL_TESTPOST = TESTPOST_SERVICIO + "/{0}";
