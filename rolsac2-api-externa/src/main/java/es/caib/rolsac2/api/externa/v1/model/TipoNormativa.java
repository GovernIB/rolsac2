 ...
 */
@XmlRootElement
@Schema(name = "TipoNormativa", description = Constantes.TXT_DEFINICION_CLASE + Constantes.ENTIDAD_TIPO_NORMATIVA)
public class TipoNormativa extends EntidadBase<TipoNormativa> {

	private static final Logger LOG = LoggerFactory.getLogger(TipoNormativa.class);
