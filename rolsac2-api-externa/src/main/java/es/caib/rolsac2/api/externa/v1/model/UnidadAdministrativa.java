...
public class UnidadAdministrativa extends EntidadBase<UnidadAdministrativaDTO> {
    ...
    protected void generaLinks(String urlBase) {
        ...
        link_responsableSexo = this.generaLink(this.responsableSexo == null ? null : this.responsableSexo.longValue(), Constantes.ENTIDAD_TIPO_SEXO, Constantes.URL_TIPO_SEXO, urlBase, null);
    }
