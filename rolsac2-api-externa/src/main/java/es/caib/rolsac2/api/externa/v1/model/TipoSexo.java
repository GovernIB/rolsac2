 ...
 */
@XmlRootElement
@Schema(name = "TipoSexo", description = Constantes.TXT_DEFINICION_CLASE + Constantes.ENTIDAD_TIPO_SEXO)
public class TipoSexo extends EntidadBase<TipoSexo> {

	private static final Logger LOG = LoggerFactory.getLogger(TipoSexo.class);
