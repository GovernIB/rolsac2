...
EXECUTE IMMEDIATE 'ALTER TABLE ROLSAC2.RS2_UNIADM DISABLE CONSTRAINT RS2_UNIADM_UNIADM_FK';
...
EXECUTE IMMEDIATE 'ALTER SEQUENCE ROLSAC2.RS2_UNIADM_SEQ INCREMENT BY ' || maximoIdUAS;
SELECT RS2_UNIADM_SEQ.NEXTVAL INTO VALOR FROM DUAL;
EXECUTE IMMEDIATE 'ALTER SEQUENCE ROLSAC2.RS2_UNIADM_SEQ INCREMENT BY 1';

COMMIT;

/** ACTIVAMOS LA FK **/
EXECUTE IMMEDIATE 'ALTER TABLE ROLSAC2.RS2_UNIADM ENABLE CONSTRAINT RS2_UNIADM_UNIADM_FK';
