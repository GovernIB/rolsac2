...
public interface UnitatOrganicaServiceFacade {
     ...
     * @throws RecursoNoEncontradoException si la unitat amb identificador dto.id no existeix.
     */
    void update(UnitatOrganicaDTO dto) throws RecursoNoEncontradoException;
     ...
     * @throws RecursoNoEncontradoException  si la unitat amb identificador id no existeix.
     */
    void delete(Long id) throws UnitatTeProcedimentsException, RecursoNoEncontradoException;
