...
public class FiltroProcedimientos extends EntidadJson<FiltroProcedimientos> {
     ...
     **/
    @Schema(description = "buscarEnDescendientesUA", type = SchemaType.BOOLEAN, required = false)
