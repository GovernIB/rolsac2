...
@XmlRootElement
@Schema(name = "FiltroTipoBoletin", type = SchemaType.STRING, description = "Criterios para localizar tipos de boletín")
public class FiltroTipoBoletin extends EntidadJson<FiltroTipoBoletin> {
     ...
     * texto.
     **/
    @Schema(name = "texto", description = "Texto a buscar en el identificador o descripción del tipo de boletín", type = SchemaType.STRING, required = false)
    private String texto;

    /**
     * FiltroPaginacion.
     **/
    @Schema(name = "filtroPaginacion", description = "Página y número máximo de tipos de boletín que se devolverán", required = false)
