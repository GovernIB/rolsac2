...
public class TipoVia extends EntidadBase<TipoVia> {
     ...
     * Identificador
     */
    @Schema(description = "Identificador del tipo de vía", name = "identificador", type = SchemaType.STRING, required = true)
    private String identificador;

    /**
     * descripcion.
     **/
    @Schema(description = "Descripción del tipo de vía", name = "descripcion", type = SchemaType.STRING, required = false)
    private String descripcion;

    /**
     * codigo
     **/
    @Schema(description = "Código numérico del tipo de vía", name = "codigo", type = SchemaType.INTEGER, required = false)
    private Long codigo;
