package es.caib.rolsac2.api.interna.services;
...
public class PersonalResourceIT {
    ...
    public static WebArchive createDeployment() {
        try {
            WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
                    ...
                    .addPackages(false, "es.caib.rolsac2.api.interna")
                    .addPackages(false, "es.caib.rolsac2.api.interna.services")
                    .addPackages(true, "es.caib.rolsac2.commons.rest")
                    .addPackages(true, "es.caib.rolsac2.service")
                    .addPackages(true, "es.caib.rolsac2.ejb")
                    .addPackages(true, "es.caib.rolsac2.persistence")
                    .addAsResource(
     ...
     *
     @Test
     @InSequence(1) public void testCreateUnitat() {

     // Dades de la nova unitat orgànica que crearem
     Personal newUnitat = new UnitatOrganicaDTO();
     ...
     *
     @Test
     @InSequence(2) public void testCreateUnitatError() {
     ...
     *
     @Test
     @InSequence(2) public void testGetUnitat() {
     ...
     *
     @Test
     @InSequence(2) public void testGetUnitatError() {
     ...
     *
     @Test
     @InSequence(3) public void testGetAllUnitats() {
     ...
     *
     @Test
     @InSequence(4) public void testUpdateUnitat() {
     ...
     *
     @Test
     @InSequence(4) public void testUpdateUnitatError() {
     ...
     *
     @Test
     @InSequence(5) public void testDelete() {
     ...
     *
     @Test
     @InSequence(5) public void testDeleteError() {
     ...
     *
     @Test
     @InSequence(6) public void testCorsHeaderPreflight() {
     ...
     *
     @Test
     @InSequence(7) public void testCorsHeaderGet() {
     ...
     *
     @Test
     @InSequence(8) public void testCorsHeaderOpenApi() {
