package es.caib.rolsac2.rest.api.externa;
...
@OpenAPIDefinition(info = @Info(title = "API REST EXTERNA", version = "1.1.0"), servers = {@Server(url = "/rolsac2api/externa", description = "localhost")}
