...
import es.caib.rolsac2.api.interna.v1.model.TipoMediaEdificio;
import es.caib.rolsac2.api.interna.v1.model.filters.FiltroTipoMediaEdificio;
...
public class TipoMediaEdificioResource {
    ...
    private RespuestaBase getRespuesta(TipoMediaEdificioFiltro fg, Instant start, String url) {
