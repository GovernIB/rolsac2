...
import es.caib.rolsac2.api.interna.v1.model.TipoMediaFicha;
import es.caib.rolsac2.api.interna.v1.model.filters.FiltroTipoMediaFicha;
...
public class TipoMediaFichaResource {
    ...
    private RespuestaBase getRespuesta(TipoMediaFichaFiltro fg, Instant start, String url, Integer apiMaxLimit) {
