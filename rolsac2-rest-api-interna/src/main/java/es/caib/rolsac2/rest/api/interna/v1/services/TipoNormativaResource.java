...
import es.caib.rolsac2.api.interna.v1.model.TipoNormativa;
import es.caib.rolsac2.api.interna.v1.model.filters.FiltroTipoNormativa;
...
public class TipoNormativaResource {
    ...
    private RespuestaBase getRespuesta(TipoNormativaFiltro fg, Instant start, String url,Integer apiMaxLimit) {
