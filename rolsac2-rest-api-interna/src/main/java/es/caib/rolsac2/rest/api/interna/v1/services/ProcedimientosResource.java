...
public class ProcedimientosResource {
    ...
    @Path("/")
    @Operation(operationId = "listarProcedimientos", summary = "Lista los procedimientos", description = "Lista los procedimientos disponibles en función de los filtros")
