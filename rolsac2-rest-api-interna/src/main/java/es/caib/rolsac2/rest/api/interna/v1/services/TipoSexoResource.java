...
import es.caib.rolsac2.api.interna.v1.model.TipoSexo;
import es.caib.rolsac2.api.interna.v1.model.filters.FiltroTipoSexo;
...
public class TipoSexoResource {
    ...
    private RespuestaBase getRespuesta(TipoSexoFiltro fg, Instant start, String url, Integer apiMaxLimit) {
