...
public class EntidadesResource {
    ...
    @Path("/")
    @Operation(operationId = "listarEntidad", summary = "Lista las entidades", description = "Lista las entidades disponibles que cumplen el filtro indicado")
    ...
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_FORM_URLENCODED})
    @Path("/{codigo}")
    @Operation(operationId = "getEntidad", summary = "Obtiene una entidad", description = "Obtiene la entidad identificada por el código indicado")
    @APIResponse(responseCode = "200", description = Constantes.MSJ_200_GENERICO, content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RespuestaBase.class)))
    @APIResponse(responseCode = "400", description = Constantes.MSJ_400_GENERICO, content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = RespuestaError.class)))
