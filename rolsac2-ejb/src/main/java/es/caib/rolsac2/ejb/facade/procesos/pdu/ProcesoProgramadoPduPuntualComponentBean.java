...
import es.caib.rolsac2.ejb.facade.procesos.solr.ProcesoProgramadoBaseSolrComponentBean;
 ...
 * @author Indra
 */
@Stateless(name = "procesoProgramadoPduPuntualComponent")
...
public class ProcesoProgramadoPduPuntualComponentBean extends ProcesoProgramadoBasePduComponentBean implements ProcesoProgramadoFacade {

    /**
     * Código interno del proceso
     */
    private static final TypeTipoProceso TIPO_PROCESO = TypeTipoProceso.PDU_PUNT;

    /**
     * log.
     */
    private static Logger log = LoggerFactory.getLogger(ProcesoProgramadoPduPuntualComponentBean.class);

    @Override
    @RolesAllowed({TypePerfiles.ADMINISTRADOR_CONTENIDOS_VALOR, TypePerfiles.ADMINISTRADOR_ENTIDAD_VALOR, TypePerfiles.SUPER_ADMINISTRADOR_VALOR, TypePerfiles.GESTOR_VALOR, TypePerfiles.INFORMADOR_VALOR})
    public String getCodigoProceso() {
        return TIPO_PROCESO.valor;
    }

    @Override
    @RolesAllowed({TypePerfiles.ADMINISTRADOR_CONTENIDOS_VALOR, TypePerfiles.ADMINISTRADOR_ENTIDAD_VALOR, TypePerfiles.SUPER_ADMINISTRADOR_VALOR, TypePerfiles.GESTOR_VALOR, TypePerfiles.INFORMADOR_VALOR})
    public ResultadoProcesoProgramado ejecutar(final Long instanciaProceso, final ListaPropiedades params, Long idEntidad) {
        return super.ejecutarPadre(instanciaProceso, params, idEntidad);
    }
