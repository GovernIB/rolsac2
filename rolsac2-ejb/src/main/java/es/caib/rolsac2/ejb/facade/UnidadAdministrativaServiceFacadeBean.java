...
public class UnidadAdministrativaServiceFacadeBean implements UnidadAdministrativaServiceFacade {
    ...
    public Literal obtenerPadreDir3(Long codigoUA) {
        return unidadAdministrativaRepository.obtenerPadreDir3(codigoUA);
    }
    ...
    @Override
    @RolesAllowed({TypePerfiles.ADMINISTRADOR_CONTENIDOS_VALOR, TypePerfiles.ADMINISTRADOR_ENTIDAD_VALOR, TypePerfiles.SUPER_ADMINISTRADOR_VALOR, TypePerfiles.GESTOR_VALOR, TypePerfiles.INFORMADOR_VALOR})
    public List<Long> listarDescendientes(Long codigoUA) {
        return unidadAdministrativaRepository.listarDescendientes(codigoUA);
    }
