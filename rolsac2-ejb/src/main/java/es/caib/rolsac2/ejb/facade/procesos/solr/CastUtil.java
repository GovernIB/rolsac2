...
public class CastUtil {
        ...
        for (final String keyIdioma : servicio.getNombreProcedimientoWorkFlow().getIdiomas()) {
            ...
            if (enumIdioma != null) {
                ...
                for (final TemaGridDTO tema : servicio.getTemas()) {
                    ...
                    textoOptional.append(tema.getCodigo());
                    textoOptional.append(" ");
    ...
    public static IndexFile getDataIndexacion(ProcedimientoDTO proc, ProcedimientoDocumentoDTO doc, DocumentoTraduccion docIdioma, FicheroDTO ficheroDTO, String idioma, PathUA pathUA) {
        ...
        if (enumIdioma != null) {
            ...
            // materia
            for (final TemaGridDTO temaGridDTO : proc.getTemas()) {
                textoOptional.append(" ");
                textoOptional.append(temaGridDTO.getCodigo());
                textoOptional.append(" ");
            ...
            // Servicio Responsable
            if (proc.getUaResponsable() != null && proc.getUaInstructor().getNombre() != null && proc.getUaInstructor().getNombre().getTraduccion(idioma) != null) {
                textoOptional.append(" ");
    ...
    public static DataIndexacion getDataIndexacion(ProcedimientoDTO proc, PathUA pathUA) {
        ...
        for (final String keyIdioma : proc.getNombreProcedimientoWorkFlow().getIdiomas()) {
            ...
            if (enumIdioma != null) {
                ...
                // Servicio Responsable
                if (proc.getUaResponsable() != null && proc.getUaInstructor().getNombre() != null && proc.getUaInstructor().getNombre().getTraduccion(keyIdioma) != null) {
                    textoOptional.append(" ");
