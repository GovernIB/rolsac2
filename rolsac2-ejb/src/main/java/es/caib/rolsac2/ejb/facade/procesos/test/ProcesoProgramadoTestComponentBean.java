        ...
        if (params != null) {
            ...
            if (params.getPropiedad("valida") != null) {
                ...
                if (!valida) {
                    ...
                    res.setMensajeErrorTraza("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ullamcorper semper laoreet. Nulla ut ex felis. " + "Proin metus urna, venenatis blandit commodo sit amet, dictum eget diam. Nullam tempor tempus nunc, commodo ornare elit dictum id. " + "Suspendisse semper blandit felis et facilisis. Donec sodales quam vitae lorem iaculis aliquam. Quisque faucibus, lorem in rutrum egestas, " + "turpis orci lobortis elit, eget sagittis libero ligula at nulla. Praesent consectetur nisl ac orci faucibus fringilla ac a libero. " + "Etiam tristique mauris massa, ac laoreet dolor tincidunt ac. Fusce finibus eget ex a mollis. Aliquam vel aliquam velit. " + "Curabitur placerat mi non eros commodo molestie. Proin venenatis turpis tincidunt felis dignissim pretium id nec lectus.");
                } else {
                    res.setFinalizadoOk(true);
                }
            }
