/***************************************************************************************************************
 ****************    script que define los idiomas de los calendarios de Primefaces  ***************************
 * Se define porque utilizando los parámetros firstDay y firstDayOfWeek en el xhtml no funcionan correctamente *
 ***************************************************************************************************************/
...
PrimeFaces.locales['ca'] = {
    ...
    dayNamesMin: ['D', 'Dl', 'Dt', 'Dc', 'Dj', 'Dv', 'Ds'],
    weekHeader: 'Setmana',
    firstDay: 1,
    firstDayOfWeek: 1,
    isRTL: false,
    ...
    messages: { // Optional per a validació al costat del client
