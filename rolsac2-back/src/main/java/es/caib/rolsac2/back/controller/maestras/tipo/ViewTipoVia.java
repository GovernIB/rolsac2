...
public class ViewTipoVia extends AbstractController implements Serializable {
  ...
  public void buscar() {
    lazyModel = new LazyDataModel<>() {
      ...
      @Override
      public List<TipoViaGridDTO> load(
        ...
        try {
          ...
          Pagina<TipoViaGridDTO> pagina = pagina = new Pagina(new ArrayList(), 3);
          setRowCount((int) pagina.getTotal());
          return pagina.getItems();
        }
      }
  ...
  private void abrirVentana(TypeModoAcceso modoAcceso) {
    ...
    UtilJSF.openDialog("dialogTipoVia", modoAcceso, params, true, 800, 200);
  ...
  public void borrarTipoVia() {
    if (datoSeleccionado == null) {
      ...
      tipoViaService.delete(datoSeleccionado.getId());
