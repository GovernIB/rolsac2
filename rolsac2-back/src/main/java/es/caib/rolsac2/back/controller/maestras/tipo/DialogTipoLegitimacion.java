...
public class DialogTipoLegitimacion extends AbstractController implements Serializable {
    ...
    public void returnDialogTraducir(final SelectEvent event) {
        ...
        TipoLegitimacionDTO datoDTO = (TipoLegitimacionDTO) respuesta.getResult();
    ...
    private boolean verificarGuardar() {
        if (Objects.isNull(this.data.getCodigo()) && tipoLegitimacionService.existeIdentificadorTipoLegitimacion(
        ...
        if (Objects.nonNull(this.data.getCodigo()) && !identificadorAntiguo.equals(this.data.getIdentificador())
                && tipoLegitimacionService.existeIdentificadorTipoLegitimacion(this.data.getIdentificador())) {
            UtilJSF.addMessageContext(TypeNivelGravedad.ERROR, getLiteral("msg.existeIdentificador"), true);
            return false;
        }
