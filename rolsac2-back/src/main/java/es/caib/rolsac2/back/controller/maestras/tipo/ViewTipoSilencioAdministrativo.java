...
public class ViewTipoSilencioAdministrativo extends AbstractController implements Serializable {
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public String getRowKey(TipoSilencioAdministrativoGridDTO objeto) {
            ...
            @Override
            public List<TipoSilencioAdministrativoGridDTO> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filterBy) {
                try {
                    filtro.setIdioma(sessionBean.getLang());
    ...
    private void abrirVentana(TypeModoAcceso modoAcceso) {
        ...
        UtilJSF.openDialog("dialogTipoSilencioAdministrativo", modoAcceso, params, true, 850, 320);
    }
