...
@Named
@ViewScoped
public class TipoNormativaConverter implements Converter, Serializable {

    private static final long serialVersionUID = -8972013394803135445L;

    @Inject
    private TipoNormativaServiceFacade tipoNormativaServiceFacade;
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String s) {
        ...
        if (s != null && s.trim().length() > 0) {
            return tipoNormativaServiceFacade.findTipoNormativaByCodigo(Long.parseLong(s));
        } else {
            return null;
        }
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object o) {
        if (o != null) {
            return String.valueOf(((TipoNormativaDTO) o).getCodigo());
        } else {
            return null;
        }
    }
