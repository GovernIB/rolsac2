...
public class DialogTipoVia extends AbstractController implements Serializable {
  ...
  @EJB
  TipoViaServiceFacade tipoViaService;
  ...
  public void load() {
    ...
    if (this.isModoAlta()) {
      ...
      data = tipoViaService.findById(Long.valueOf(id));
  ...
  private boolean verificarGuardar() {
    if (Objects.isNull(this.data.getId()) && tipoViaService.existeIdentificador(this.data.getIdentificador())) {
      UtilJSF.addMessageContext(TypeNivelGravedad.ERROR, getLiteral("msg.existeIdentificador"), true);
      return false;
    }

    if (Objects.nonNull(this.data.getId()) && !identificadorAntiguo.equals(this.data.getIdentificador())
      && tipoViaService.existeIdentificador(this.data.getIdentificador())) {
      UtilJSF.addMessageContext(TypeNivelGravedad.ERROR, getLiteral("msg.existeIdentificador"), true);
      return false;
    }
