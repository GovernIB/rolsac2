...
public class ViewTipoNormativa extends AbstractController implements Serializable {
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public String getRowKey(TipoNormativaGridDTO objeto) {
            ...
            @Override
            public List<TipoNormativaGridDTO> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filterBy) {
                try {
                    filtro.setIdioma(sessionBean.getLang());
    ...
    private void abrirVentana(TypeModoAcceso modoAcceso) {
        ...
        UtilJSF.openDialog("dialogTipoNormativa", modoAcceso, params, true, 850, 430);
    }
