...
public abstract class AbstractController {
    ...
    public boolean tradExiste() {
        return administracionEntServiceFacade.existePluginTipoByEntidad(sessionBean.getEntidad().getCodigo(), TypePluginEntidad.TRADUCCION.toString());
    }

    public void permisoAccesoVentana(Class clase) {
        if (clase != null && clase.equals(ViewMisAlertas.class)) {
            //Todos pueden acceder al viewMisAlertas
            return;
        }

        if (!(clase != null && (isSuperadministrador() && (clase.equals(ViewEntidades.class) || clase.equals(ViewConfiguracionesGlobales.class) || clase.equals(ViewTipoAfectacion.class) || clase.equals(ViewTipoMateriaSIA.class) || clase.equals(ViewTipoFormaInicio.class) || clase.equals(ViewTipoNormativa.class) || clase.equals(ViewTipoSexo.class) || clase.equals(ViewTipoBoletin.class) || clase.equals(ViewTipoVia.class) || clase.equals(ViewTipoPublicoObjetivo.class) || clase.equals(ViewTipoSilencioAdministrativo.class) || clase.equals(ViewTipoLegitimacion.class) || clase.equals(ViewUsuario.class)) || isAdministradorEntidad() && (clase.equals(ViewConfiguracionEntidad.class) || clase.equals(ViewPlugins.class) || clase.equals(ViewConfiguracionesAlertas.class) || clase.equals(ViewUsuario.class) || clase.equals(ViewEntidadRaiz.class) || clase.equals(ViewRoles.class) || clase.equals(ViewTipoUnidadAdministrativa.class) || clase.equals(ViewEntidades.class) || clase.equals(ViewTipoMediaUA.class) || clase.equals(ViewPlatTramitElectronica.class) || clase.equals(ViewTipoTramitacion.class) || clase.equals(ViewTipoProcedimiento.class) || clase.equals(ViewTema.class) || clase.equals(ViewPublicoObjetivoEntidad.class) || clase.equals(ViewTipoMediaFicha.class) || clase.equals(ViewConfiguracionesAlertas.class) || clase.equals(ViewEventosPlat.class) || clase.equals(ViewProcesos.class) || clase.equals(ViewProcesosSolr.class) || clase.equals(ViewProcesosSIA.class) || clase.equals(ViewProcesosMigracion.class) || clase.equals(ViewProcesosLog.class) || clase.equals(ViewEvolucion.class) || clase.equals(ViewContenidos.class) || clase.equals(ViewUnidadAdministrativa.class)) || clase.equals(ViewLOPD.class) || clase.equals(ViewOrganigramaDir3.class) || (isAdministradorContenidos() && (clase.equals(ViewUnidadAdministrativa.class) || clase.equals(ViewNormativa.class)) || (isAdministradorContenidos() || isGestor() || isInformador()) && clase.equals(ViewProcedimientos.class) || clase.equals(ViewServicios.class))))) {
