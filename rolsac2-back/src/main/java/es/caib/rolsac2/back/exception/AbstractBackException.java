 ...
 */
public abstract class AbstractBackException extends RuntimeException {

    private static final long serialVersionUID = 1L;

    public AbstractBackException() {
        super();
    }

    public AbstractBackException(Throwable cause) {
        super(cause);
    }
    ...
    private ResourceBundle getBundle(Locale locale) {
        return ResourceBundle.getBundle("back.ExceptionMessages", locale);
    }
