...
public class ViewTipoSexo extends AbstractController implements Serializable {
    ...
    public void load() {
        LOG.debug("load");
        permisoAccesoVentana(ViewTipoSexo.class);
        this.setearIdioma();
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public String getRowKey(TipoSexoGridDTO objeto) {
            ...
            @Override
            public List<TipoSexoGridDTO> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filterBy) {
                try {
    ...
    private void abrirVentana(TypeModoAcceso modoAcceso) {
        ...
        UtilJSF.openDialog("dialogTipoSexo", modoAcceso, params, true, 800, 330);
