...
public class ViewTipoSexo extends AbstractController implements Serializable {
    ...
    lazyModel = new LazyDataModel<>() {
      ...
      public List<TipoSexoGridDTO> load(
        ...
        try {
          ...
          Pagina<TipoSexoGridDTO> pagina = pagina = new Pagina(new ArrayList(), 3);
          setRowCount((int) pagina.getTotal());
          return pagina.getItems();
        }
      }
  ...
  private void abrirVentana(TypeModoAcceso modoAcceso) {
    ...
    UtilJSF.openDialog("dialogTipoSexo", modoAcceso, params, true, 800, 200);
  ...
  public void borrarTipoSexo() {
    if (datoSeleccionado == null) {
      ...
      tipoSexoService.delete(datoSeleccionado.getId());
