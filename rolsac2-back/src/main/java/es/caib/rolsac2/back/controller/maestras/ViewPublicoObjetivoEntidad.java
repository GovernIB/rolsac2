...
public class ViewPublicoObjetivoEntidad extends AbstractController implements Serializable {
    ...
    public void abrirVentana(TypeModoAcceso modoAcceso) {
        ...
        UtilJSF.openDialog("dialogTipoPublicoObjetivoEntidad", modoAcceso, params, true, 800, 330);
    }
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public List<TipoPublicoObjetivoEntidadGridDTO> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, FilterMeta> filterBy) {
                try {
