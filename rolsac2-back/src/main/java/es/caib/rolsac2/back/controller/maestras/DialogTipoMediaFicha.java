...
@Named
@ViewScoped
public class DialogTipoMediaFicha extends AbstractController implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(DialogTipoMediaFicha.class);
    ...
    public void returnDialogTraducir(final SelectEvent event) {
        ...
        TipoMediaFichaDTO datoDTO = (TipoMediaFichaDTO) respuesta.getResult();
    ...
    public void guardar() {
        ...
        if (this.data.getCodigo() == null) {
            tipoMediaFichaService.create(this.data);
        } else {
            tipoMediaFichaService.update(this.data);
        }
    ...
    private boolean verificarGuardar() {
        if (Objects.isNull(this.data.getCodigo()) && tipoMediaFichaService.existeIdentificadorTipoMediaFicha(
        ...
        if (Objects.nonNull(this.data.getCodigo()) && !identificadorAntiguo.equals(this.data.getIdentificador())
                && tipoMediaFichaService.existeIdentificadorTipoMediaFicha(this.data.getIdentificador())) {
            UtilJSF.addMessageContext(TypeNivelGravedad.ERROR, getLiteral("msg.existeIdentificador"), true);
            return false;
        }
    ...
    public TipoMediaFichaDTO getData() {
        return data;
    }

    public void setData(TipoMediaFichaDTO data) {
        this.data = data;
    }
