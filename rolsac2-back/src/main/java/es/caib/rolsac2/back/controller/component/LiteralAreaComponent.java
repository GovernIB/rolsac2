...
@FacesComponent(createTag = true, tagName = "literalAreaComponent", namespace = "http://back.rolsac2.caib.es/tags")
public class LiteralAreaComponent extends UIInput implements NamingContainer {
    ...
    public void encodeBegin(FacesContext context) throws IOException {
        ...
        if (inicializado == null || inicializado.isEmpty()) {
            ...
            if (ocultarTexto != null && "true".equalsIgnoreCase(ocultarTexto)) {
                ((InputTextarea) texto).setStyle("display:none;");
            }
