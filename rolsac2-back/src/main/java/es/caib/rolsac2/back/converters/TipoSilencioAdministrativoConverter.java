...
@Named
@ViewScoped
public class TipoSilencioAdministrativoConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String s) {
        ...
        if (s != null && s.trim().length() > 0) {
            return maestrasSupServiceFacade.findTipoSilencioAdministrativoById(Long.parseLong(s));
        } else {
            return null;
        }
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object o) {
        if (o != null) {
            return String.valueOf(((TipoSilencioAdministrativoDTO) o).getCodigo());
        } else {
            return null;
        }
    }
