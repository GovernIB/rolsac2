        ...
        lazyModel = new LazyDataModel<>() {
            ...
            public EdificioGridDTO getRowData(String rowKey) {
                for (EdificioGridDTO Edificio : getWrappedData()) {
                    if (Edificio.getCodigo().toString().equals(rowKey))
                        return Edificio;
                }
                return null;
            }
            ...
            @Override
            public Object getRowKey(EdificioGridDTO tipoMateriaSIA) {
                return tipoMateriaSIA.getCodigo().toString();
            }

            @Override
            public List<EdificioGridDTO> load(int first, int pageSize, String sortField, SortOrder sortOrder,
