...
@Named
@ViewScoped
public class TipoProcedimientoConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String s) {
        ...
        if (s != null && s.trim().length() > 0) {
            return maestrasSupServiceFacade.findTipoProcedimientoById(Long.parseLong(s));
        } else {
            return null;
        }
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object o) {
        if (o != null) {
            return String.valueOf(((TipoProcedimientoDTO) o).getCodigo());
        } else {
            return null;
        }
    }
