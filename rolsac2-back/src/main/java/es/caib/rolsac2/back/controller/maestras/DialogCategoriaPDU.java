...
@Named
@ViewScoped
public class DialogCategoriaPDU extends AbstractController implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(DialogCategoriaPDU.class);

    private String id;
    @EJB
    private MaestrasEntServiceFacade categoriaPDUService;

    @EJB
    private AdministracionSupServiceFacade administracionSupServiceFacade;

    private CategoriaPDUDTO data;
    private String identificadorAntiguo;
    private Literal descripcion;
    private CategoriaPDUDTO dataOriginal;
    ...
    public void load() {
        ...
        if (this.isModoAlta()) {
            ...
            data = categoriaPDUService.findCategoriaPduDTOById(Long.valueOf(id));
    ...
    public void returnDialogTraducir(final SelectEvent event) {
        ...
        CategoriaPDUDTO datoDTO = (CategoriaPDUDTO) respuesta.getResult();
    ...
    public void abrirDlg() {
        final Map<String, String> params = new HashMap<>();
        UtilJSF.openDialog("dialogcategoriaPDU", TypeModoAcceso.ALTA, params, true, 1050, 550);
    }
    ...
    public void guardar() {
        ...
        if (this.data.getCodigo() == null) {
            categoriaPDUService.create(this.data);
        } else {
            categoriaPDUService.update(this.data);
        }
    ...
    private boolean verificarGuardar() {
        if (Objects.isNull(this.data.getCodigo()) && categoriaPDUService.existeIdentificadorCategoriaPdu(
        ...
        if (Objects.nonNull(this.data.getCodigo()) && !identificadorAntiguo.equals(this.data.getIdentificador())
                && categoriaPDUService.existeIdentificadorCategoriaPdu(this.data.getIdentificador(), sessionBean.getEntidad().getCodigo())) {
            UtilJSF.addMessageContext(TypeNivelGravedad.ERROR, getLiteral("msg.existeIdentificador"), true);
            return false;
        }
    ...
    public CategoriaPDUDTO getData() {
        return data;
    }

    public void setData(CategoriaPDUDTO data) {
        this.data = data;
    }
