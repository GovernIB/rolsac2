...
@Named
@ViewScoped
public class DialogEvolucionCompetenciasUnidadAdministrativa extends EvolucionController implements Serializable {
	private static final Logger LOG = LoggerFactory.getLogger(DialogEvolucionCompetenciasUnidadAdministrativa.class);
