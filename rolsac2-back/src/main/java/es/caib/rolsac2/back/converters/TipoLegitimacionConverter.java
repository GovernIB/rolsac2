...
@Named
@ViewScoped
public class TipoLegitimacionConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String s) {
        ...
        if (s != null && s.trim().length() > 0) {
            return maestrasSupServiceFacade.findTipoLegitimacionById(Long.parseLong(s));
        } else {
            return null;
        }
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object o) {
        if (o != null) {
            return String.valueOf(((TipoLegitimacionDTO) o).getCodigo());
        } else {
            return null;
        }
    }
