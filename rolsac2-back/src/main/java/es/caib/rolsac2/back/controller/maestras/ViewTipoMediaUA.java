...
public class ViewTipoMediaUA extends AbstractController implements Serializable {
    ...
    public void load() {
        LOG.debug("load");
        permisoAccesoVentana(ViewTipoMediaUA.class);
        this.setearIdioma();
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public String getRowKey(TipoMediaUAGridDTO objeto) {
            ...
            @Override
            public List<TipoMediaUAGridDTO> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filterBy) {
                try {
