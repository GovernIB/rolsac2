...
public class ViewTipoLegitimacion extends AbstractController implements Serializable {
    ...
    public void load() {
        LOG.debug("load");
        permisoAccesoVentana(ViewTipoLegitimacion.class);
        this.setearIdioma();
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public List<TipoLegitimacionGridDTO> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, FilterMeta> filterBy) {
                try {
    ...
    private void abrirVentana(TypeModoAcceso modoAcceso) {
        ...
        UtilJSF.openDialog("dialogTipoLegitimacion", modoAcceso, params, true, 800, 322);
