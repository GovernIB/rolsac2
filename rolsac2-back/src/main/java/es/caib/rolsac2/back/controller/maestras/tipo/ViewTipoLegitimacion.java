...
public class ViewTipoLegitimacion extends AbstractController implements Serializable {
    ...
    lazyModel = new LazyDataModel<>() {
      ...
      public List<TipoLegitimacionGridDTO> load(
        ...
        try {
          ...
          Pagina<TipoLegitimacionGridDTO> pagina = pagina = new Pagina(new ArrayList(), 3);
          setRowCount((int) pagina.getTotal());
          return pagina.getItems();
        }
      }
  ...
  private void abrirVentana(TypeModoAcceso modoAcceso) {
    ...
    UtilJSF.openDialog("dialogTipoLegitimacion", modoAcceso, params, true, 800, 200);
  ...
  public void borrarTipoLegitimacion() {
    if (datoSeleccionado == null) {
      ...
      tipoLegitimacionService.delete(datoSeleccionado.getId());
