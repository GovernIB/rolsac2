...
public class ViewTipoTramitacion extends AbstractController implements Serializable {
    ...
    public void buscar() {
        lazyModel = new LazyDataModel<>() {
            ...
            @Override
            public List<TipoTramitacionGridDTO> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, FilterMeta> filterBy) {
                try {
                    filtro.setIdioma(sessionBean.getLang());
    ...
    private void abrirVentana(TypeModoAcceso modoAcceso) {
        ...
        UtilJSF.openDialog("dialogTipoTramitacion", modoAcceso, params, true, 780, 510);
    }
