...
@NamedQueries({
  @NamedQuery(name = JTipoViaTraduccion.FIND_BY_ID,
    query = "select p from JTipoViaTraduccion p where p.id = :id")
})
public class JTipoViaTraduccion extends BaseEntity {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, that.id) && Objects.equals(tipoVia,
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tipoVia, idioma, descripcion);
  }
}
