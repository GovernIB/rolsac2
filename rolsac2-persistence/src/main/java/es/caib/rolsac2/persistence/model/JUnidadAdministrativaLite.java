...
@NamedQueries({@NamedQuery(name = JUnidadAdministrativaLite.FIND_BY_ID, query = "select p from JUnidadAdministrativa p where p.codigo = :id"), @NamedQuery(name = JUnidadAdministrativaLite.COUNT_BY_IDENTIFICADOR, query = "select count(p) from JUnidadAdministrativa p where p.identificador = :identificador")})

public class JUnidadAdministrativaLite extends BaseEntity {

    private static final long serialVersionUID = 1L;

    public static final String FIND_BY_ID = "UnidadAdministrativaLite.FIND_BY_ID";
    public static final String COUNT_BY_IDENTIFICADOR = "UnidadAdministrativaLite.COUNT_BY_IDENTIFICADOR";
    ...
    @Column(name = "UNAD_CODENTI", nullable = false)
    ...
    public void setEntidad(Long unadCodenti) {
    ...
    public void setPadre(Long unadUnadpadre) {
    ...
    public boolean equals(Object o) {
        ...
        JUnidadAdministrativaLite that = (JUnidadAdministrativaLite) o;
