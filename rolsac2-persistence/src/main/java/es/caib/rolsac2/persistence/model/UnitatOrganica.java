 ...
 */
@Entity
@SequenceGenerator(name = "uo-sequence", sequenceName = "RSC_UNITATORGANICA_SEQ", allocationSize = 1)
@Table(name = "RSC_UNITATORGANICA",
        uniqueConstraints = {
                @UniqueConstraint(name = "RSC_UNITAT_CODIDIR3_UK", columnNames = "CODIDIR3")
        },
        indexes = {
                @Index(name = "RSC_UNITAT_PK_I", columnList = "ID"),
                @Index(name = "RSC_UNITAT_CODIDIR3_UK_I", columnList = "CODIDIR3")
        }
)
@NamedQueries({
